...
_AUTHORED_WORLD = [
    ("Фэндалин — захолустный городок у подножия Каменных холмов; закон тут слаб", "phandalin", 0.0, ["фэндалин", "город"]),
...
def _world_digest(world) -> str:
    ...
    return ("Фэндалин — фронтирный городок у Каменных холмов; вокруг дикие земли и места: "
            f"{sites}. В округе действуют Красные плащи, гоблины Крэгмо, Жентарим, Арфисты, "
            "Союз Лордов; рудник заброшен, дороги небезопасны.")
