...
KNOWLEDGE_DOMAINS: dict[str, dict] = {
    "_everyone": {"bestiary": {"max_tier": 1}, "equipment": {"max_tier": 9},
                  "materials": {"max_tier": 0}, "flora": {"max_tier": 9}, "conditions": {"max_tier": 9},
                  "classes": {"max_tier": 9}},   # слабьё, снарягу, дешёвые материалы, обычные растения, состояния и классы — все
    ...
    "жрец":     {"bestiary": {"types": {"undead", "fiend", "celestial", "aberration"}, "max_tier": 30},
                 "spells": {"max_tier": 9}, "planes": {"max_tier": 9}},
    ...
    "маг":      {"bestiary": {"max_tier": 30}, "spells": {"max_tier": 9}, "magicitems": {"max_tier": 6}, "planes": {"max_tier": 9}},
    "mage":     {"bestiary": {"max_tier": 30}, "spells": {"max_tier": 9}, "magicitems": {"max_tier": 6}, "planes": {"max_tier": 9}},
    "wizard":   {"bestiary": {"max_tier": 30}, "spells": {"max_tier": 9}, "magicitems": {"max_tier": 6}, "planes": {"max_tier": 9}},
    "мудрец":   {"bestiary": {"max_tier": 30}, "spells": {"max_tier": 9}, "magicitems": {"max_tier": 6}, "planes": {"max_tier": 9}},
    "sage":     {"bestiary": {"max_tier": 30}, "spells": {"max_tier": 9}, "magicitems": {"max_tier": 6}, "planes": {"max_tier": 9}},
    "учёный":   {"bestiary": {"max_tier": 30}, "spells": {"max_tier": 9}, "magicitems": {"max_tier": 6}, "planes": {"max_tier": 9}},
